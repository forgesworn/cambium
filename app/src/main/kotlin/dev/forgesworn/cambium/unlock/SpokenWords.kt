...
/**
 * spoken-token's en-v1 word list (forgesworn/spoken-token, MIT): 2048 words of 3 to 8 lower-case
 * letters, chosen to be told apart when read aloud. Copied verbatim from heartwood-esp32's
 * `common/src/spoken_words.txt` -- the firmware compiles in the same bytes -- so this must be
 * regenerated together with that file if it ever changes, never edited independently.
 *
 * SHA-256 of the words joined with "\n" (no trailing newline) is pinned by
 * `SpokenWordsTest`: `0334930ebdfbc76e81ec914515d7567ca85738a6bf3069249d97df951d44661c`.
 */
object SpokenWords {
